...
class MaskIOU(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        # start from (B, ?, H, W) to (B, 1)
        self.relu = nn.ReLU()
        self.conv1 = nn.Conv2d(49, 48, kernel_size=3, stride=1, padding=1)
        # self.conv2 = nn.Conv2d(48, 48, kernel_size=3, stride=2, padding=1)
        # self.conv3 = nn.Conv2d(48, 48, kernel_size=3, stride=2, padding=1)
...
def build_maskiou(num_classes):
    return MaskIOU(num_classes)